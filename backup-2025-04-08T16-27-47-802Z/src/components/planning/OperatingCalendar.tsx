    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent>
          <div className="flex justify-between items-center mb-4">
            ...
            <Button variant="default" size="sm" onClick={() => setShowEventForm(true)} icon={<PlusIcon className="h-4 w-4" />}>
              Add Event
            </Button>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <Badge variant={getEventBadgeColor(selectedEvent.type)} size="sm">
                      {selectedEvent.title}
                    </Badge>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="h-48 bg-gray-50 rounded-md border border-gray-200 flex items-center justify-center">
                <p className="text-gray-500">Break-even chart will be displayed here</p>
              </div>
      ...
      <Card>
        <CardHeader
          ...
          subtitle="Define and manage operating seasons"
          action={
            <Button variant="default" size="sm" onClick={handleSeasonCreate}>
              Add Season
            </Button>
          }
        />
